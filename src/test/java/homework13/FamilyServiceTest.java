...
import homework13.entity.Species;
...
class FamilyServiceTest {
    ...
    void setUp() {
        ...
        mother = new Human("Maria","Stark",34,1920);
    ...
    void bornChild() {
        ...
        assertEquals(bornedChild, familyService.bornChild(family, "John","boy").getChildren().get(0));
    }
    ...
    void getPets() {
        Family family = familyService.getFamilyByIndex(1);
        assertEquals(family.getPets(),familyService.getPets(1));
    }
